;; modified by ARP: February, 2002 to do more error handling
...
;		bit of the most significant byte.
        ...
        global  fpnorm, fladd, flsub, flmul, fldiv, negmant,___fperr
...
2:
	...
	dec	c		;decrement exponent
        jp      m,fpunderflow   ;underflow - set flag and return 0
...
fldiv:
	call	fsetup		;get operands, make them +ve.
        ...
        or      e
        exx
        jp      z,fpovrflw      ; check for zero divisor
