...
#define MAX_BIBLE_IDX
struct
{
    int chapter;
    int book;
    unsigned long offset;
} bible_idx[MAX_BIBLE_IDX];
int bible_idx_num;
#define MAX_BOOKS 1024
#define MAX_BOOK_TITLE 80
char book_names[2][MAX_BOOKS][MAX_BOOK_TITLE+1]=
{
{    "Genesis", "Ge"},
{    "Exodus", "Ex"},
{    "Leviticus", "Le"},
...
#define NUM_BUILTIN_BOOKS ( (sizeof book_names) / 2 / (MAX_BOOK_TITLE+1) )
int num_books;
int cur_book;
