...
/*  A Bison parser, made from graph.y with Bison version GNU Bison version 1.24
  */
...
static const short yyrhs[] = {    -1,
    13,    14,     0,     4,     0,    15,     4,     0,     3,     0,
    15,     6,    15,     0,    15,     5,    15,     0,    15,     7,
    15,     0,    15,     8,    15,     0,     5,    15,     0,    15,
    10,    15,     0,    11,    15,    12,     0
};
...
static const char * const yytname[] = {   "$","error","$undefined.","NUM","END",
"'-'","'+'","'*'","'/'","NEG","'^'","'('","')'","input","line","exp",""
};
#endif
...
static const short yypact[] = {-32768,
    12,-32768,-32768,    15,    15,-32768,    31,    -6,    22,-32768,
    15,    15,    15,    15,    15,-32768,    -5,    -5,    -6,    -6,
    -6,     6,-32768
};
...
static const short yytable[] = {     8,
     9,    13,    14,    15,    15,    23,    17,    18,    19,    20,
    21,    22,     0,     0,     2,     3,     4,     2,     0,     4,
     0,     0,     5,     0,     0,     5,    11,    12,    13,    14,
     0,    15,     0,    16,    10,    11,    12,    13,    14,     0,
    15
};

static const short yycheck[] = {     4,
     5,     7,     8,    10,    10,     0,    11,    12,    13,    14,
    15,     0,    -1,    -1,     3,     4,     5,     3,    -1,     5,
    -1,    -1,    11,    -1,    -1,    11,     5,     6,     7,     8,
    -1,    10,    -1,    12,     4,     5,     6,     7,     8,    -1,
    10
};
...
double x;
{
   compiled[compiled_length].type=TYPE_VALUE;
   compiled[compiled_length].value=x;
   compiled_length++;
}
...
char op;
{
   compiled[compiled_length].type=op;
   compiled_length++;
}
...
double eval(double x)
{
   ...
   for(i=0;i<compiled_length;i++)
   {
      ...
      {
         case '#': stack[sp++]=compiled[i].value; break;
...
{
  int x;
  ozeditline(0,10,line,120,239);
  ptr=line;
  yyparse();
  for(x=0;x<239;x++)
    ozpoint(x,80*eval(x/240.),1);
  ozgetch();
}
