...
This is a beta test program that has undergone only very limited
...
INSTRUCTIONS: This program lets you define the order the Wizard displays
telephone entries.  Unlike the menu in the telephone application, this
also lets you choose the Sharp-unsupported "alphabetical by company
name" order.  Use this at your own risk, of course.

NOTE: The auto power off feature is disabled when IndexBy is running.
